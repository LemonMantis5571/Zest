...
| Space | A desktop-local named group of known workspaces used to filter the Projects sidebar | Stored in `~/.zest/spaces.json`; view metadata only, never an agent execution boundary |
