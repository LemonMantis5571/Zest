...
//!
//! PDFs go through [pdf-inspector](https://github.com/firecrawl/pdf-inspector) for
//! classification + Markdown extraction (no OCR). Images become Messages API
//! image blocks. Other files are read as UTF-8 text when possible.
