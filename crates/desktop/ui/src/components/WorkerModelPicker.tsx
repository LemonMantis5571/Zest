...
/**
 * A small, portal-free model menu for CLI workers.
 *
 * Native selects inherit the WebView's light browser menu, which breaks the
 * dark Zest surface. This keeps the menu local to the card so it also works
 * reliably in the desktop webview.
 */
