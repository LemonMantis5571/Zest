...
Copy a skill folder into one of the user folders above, then reopen or refresh
Zest. The Settings panel lists the skills currently found on this computer.
